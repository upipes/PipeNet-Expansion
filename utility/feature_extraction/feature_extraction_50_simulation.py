...
class ImageDatasetWithLabelsFromFilename(torch.utils.data.Dataset):
    ...
    def __init__(self, image_dir, filename_delimiter, transform=None):
        ...
        all_class_names = sorted(list(set([f.split(self.delimiter)[1] for f in self.image_files])))
    ...
    def __getitem__(self, idx):
        ...
        class_name = image_name.split(self.delimiter)[1]
...
def extract_features_and_save(dataset):
    ...
    DATASET_IMG_PATH = f'data/{dataset}'  
...
if __name__ == '__main__':
    dataset_list = ['domain1','domain2','domain3','domain4']
    # dataset_list = ['domain2']
    epoch_list = [10]
